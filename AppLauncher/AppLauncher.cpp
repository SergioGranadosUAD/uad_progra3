...
// AppLauncher.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CAppLauncherApp
...
// Único objeto CAppLauncherApp

CAppLauncherApp theApp;


// Inicialización de CAppLauncherApp
